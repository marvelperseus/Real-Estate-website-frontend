...
class AdminDealsSummary extends Component {
    ...
    render() {
      const {
        ...
        smViewport,
        xsViewport,
        grossDealCommissions,
        netDealCommissions,
        netCurrentYearDealCommissions,
        numberOfPendingDeals,
        numberOfTotalDealsData,
        netDollarAmtOfTotalDealsData,
      } = this.props;
      const {
        totalDealsPieDollarOrNum,
          ...
          <Grid container spacing={16}>
            ...
            <Grid item xs={12} md={6}>
              <StatNumberBox
                icon={DollarIcon}
                iconClass={classes.statBoxMoneyIcon}
                stat={netCurrentYearDealCommissions}
