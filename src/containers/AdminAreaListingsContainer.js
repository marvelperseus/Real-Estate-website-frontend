...
import AdminAreaListingsTableContainer from './AdminAreaListingsTableContainer';
...
@observer
class AdminAreaListingsContainer extends Component {
  constructor(props) {
    super(props);
      ...
      <div className={classes.wrapper}>
        <Query query={listingsQuery} ssr={false}>
          {({ loading, error, data }) => {
            ...
            const allListings = data.allListingsAdmin;
            ...
            return (
              <div className={classes.wrapper}>
                ...
                <AdminAreaListingsTableContainer
...
export default withStyles(styles)(AdminAreaListingsContainer);
